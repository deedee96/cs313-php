...
if ($password != $password2) {
    $_SESSION["err_message"] = "Password do not matched!";
    $page = "signUp.php";
...
if (sizeof($rows) != 0) {
    ...
    $db = get_db();
    $query = "INSERT INTO contact_information(address_1, address_2, state, zip, first_name, last_name,phone,email,user_name, city) VALUES (:address, :address2, :state, :zip, :first_name, :last_name, :phone, :email, :user_name, :city)";
    $stmt = $db->prepare($query);
    // Bind any parameters
